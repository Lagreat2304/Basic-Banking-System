<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewtransaction.aspx.cs" Inherits="viewtransaction" StylesheetTheme="SkinFile" %>
...
<link href ="style/style1.css" rel="Stylesheet" />
    <title>BBS :: View Transaction</title>
				...
				<tr>
					...
					<div align="center">
						<table border="1" width="800" cellspacing="1" style="border-collapse: collapse" bordercolor="#999999" id="table2">
							<tr>
								<td class="td2">
								<p align="left">&nbsp;&nbsp; BBS : View Transaction</td>
							</tr>
							<tr>
								<td>
