<%@ Page Language="C#" AutoEventWireup="true" CodeFile="customerdetails.aspx.cs" Inherits="customerdetails" StylesheetTheme="SkinFile" %>
...
<link href ="style/style1.css" rel="Stylesheet" />
    <title>BBS :: Customer Details</title>
</head>
<body>
    ...
    <div>
			...
			<table border="0" width="1000" cellspacing="0" id="table1" cellpadding="0">
				<tr>
					<td>
					<img border="0" src="images/top2.gif" width="1000" height="67" alt="" /></td>
				</tr>
				<tr>
					...
					<a href="mypage.aspx">HOME</a>&nbsp; | &nbsp; 
					                        ...
					                        <a href="logout.aspx">TRANSFER MONEY</a>&nbsp; | &nbsp;
                                            <a href="logout.aspx">TRANSACTIONS VIEW</a>&nbsp; | &nbsp;
					...
					<div align="center">
						<table border="1" width="573" cellspacing="1" style="border-collapse: collapse" bordercolor="#999999" id="table2">
							<tr>
								...
								<p align="left">&nbsp; BBS :&nbsp; Customer Details</td>
							</tr>
							<tr>
								<td>
